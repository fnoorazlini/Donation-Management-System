...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) || empty($password)) {
        ...
        // Define table and column names for principals
        $table = 'PRINCIPAL';
        $id_column = 'PrincipalEmail';
        $pass_column = 'PrincipalPass';

        // Prepare SQL statement
        $sql = "SELECT $id_column, $pass_column FROM $table WHERE $id_column = ?";
            ...
            if (!$result) {
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    if (password_verify($password, $row[$pass_column])) {
                        ...
                        $message = "Invalid PrincipalID or password. Please try again.";
                    }
                } else {
                    $message = "Invalid PrincipalID or password. Please try again.";
                }
...
<div class="content">
  <div class="container">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
      ...
      <a href="forgetPassword.php" style="color:green; text-decoration:none; margin-left:320px">Reset Password</a><br>
      <button type="submit">Login</button>
      <p>Don't have an account? <a href="signupPrincipal.php" style="color:#4CAF50; text-decoration:none;">Sign Up</a></p>
